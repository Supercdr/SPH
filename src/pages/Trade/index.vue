  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="trade in trade.detailArrayList"
          :key="trade.skuId"
        >
          <li>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ sendAddress.userAddress }}</span>
  ...
  methods: {
    async open() {
      let data = {
        ...
        deliveryAddress: this.sendAddress.userAddress,
        paymentWay: "ONLINE",
        orderComment: this.msg,
        orderDetailList: this.trade.detailArrayList
      };
      let result = await this.$API.reqSubmitTrade(this.trade.tradeNo, data);
      if(result.code==200){
